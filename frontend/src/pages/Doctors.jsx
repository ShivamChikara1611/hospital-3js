...
const Doctors = () => {
    ...
    return (
        <div>
            <h1 className='text-gray-800 text-center font-semibold text-4xl mt-[50px] mb-12'>Browse through the <span className='text-primary'>Doctors Specialist.</span></h1>
                ...
                <div className='w-full grid grid-cols-auto gap-4 gap-y-6'>
                    {
                        filterDoc.slice(0, doctorsToShow).map((item, index) => (
                            <div onClick={() => navigate(`/appointment/${item._id}`)} className='cursor-pointer border-2 border-opacity-50 border-primary overflow-hidden rounded-xl hover:translate-y-[-10px] transition-all duration-300' key={index}>
            ...
            {/* Load More Button */}
            <div className='flex justify-center w-full mt-10 mb-[150px]'>
