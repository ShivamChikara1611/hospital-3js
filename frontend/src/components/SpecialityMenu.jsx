...
const SpecialityMenu = () => {
    return (
        <div className='flex flex-col items-center gap-4 px-2 py-[90px] md:py-16 text-gray-200 md:h-[80vh] justify-center' id='speciality'>
            <h1 className='text-4xl sm:text-6xl mb-4 font-semibold tracking-wider'>Find by <span className='text-primary'>Speciality</span></h1>
