            ...
            <div className="relative z-10 flex flex-col justify-center gap-5 md:gap-10 bg-black/50 backdrop-blur-sm h-full w-full px-2">
                ...
                <div className='md:flex gap-5 justify-center items-center '>
                    <div className='max-w-[600px]'>
                        <h2 className='text-gray-300 text-lg mb-1'>"Your Trusted Skin Cancer Check"</h2>
                    ...
                    <div className='mt-5 md:mt-0 min-w-[180px]'>
                        <NavLink to='/skin-cancer'>
                            <button className='bg-transparent rounded-full tracking-wider border-2 text-green-500 px-5 py-3 border-green-500 hover:bg-green-500 hover:text-gray-200 transition-all duration-200'>Diagnose Yourself</button>
                        </NavLink>
                    </div>
                </div>
