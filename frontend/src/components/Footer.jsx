    ...
    return (
        <div className='bg-white/5 p-5 rounded-t-3xl'>
            ...
            <div className='md:flex md:gap-3 md:justify-center'>
                <div>
                <p className='py-5 text-sm text-center text-gray-300'>Copyright 2024@ MAX Multispeciality Hospital - <span className='text-primary'>All Right Reserved.</span></p>
                </div>

                <button className='flex flex-col items-center justify-center w-full md:w-fit mb-3 md:mb-0'><a className='bg-white/5 backdrop-blur-md text-gray-200 px-6 rounded-full hover:bg-primary/70 transition-all duration-300 font-light tracking-wider py-2.5 text-xs' href="https://www.max-hospital-admin.shivamchikara.xyz/" target="_blank" rel="noopener noreferrer">Switch to Admin</a></button>
            </div>
        </div>
    )
}
